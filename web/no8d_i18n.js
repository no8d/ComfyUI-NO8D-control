...
const TEXT = {
    en: {
        ...
        imageLoaderFolder: "Folder",
        imageLoaderRecursive: "Recursive",
        imageLoaderSortBy: "Sort by",
        imageLoaderOrder: "Order",
        imageLoaderStartIndex: "Start index",
        imageLoaderMaxImages: "Max images",
        imageLoaderImages: "Images",
        imageLoaderPaths: "Paths",
        imageLoaderFilenames: "Filenames",
        imageLoaderCount: "Count",
    },
    zh: {
        sampler: "采样器",
        scheduler: "Sched",
        ...
        imageLoaderFolder: "文件夹",
        imageLoaderRecursive: "包含子文件夹",
        imageLoaderSortBy: "排序方式",
        imageLoaderOrder: "顺序",
        imageLoaderStartIndex: "起始序号",
        imageLoaderMaxImages: "最大数量",
        imageLoaderImages: "图像",
        imageLoaderPaths: "路径",
        imageLoaderFilenames: "文件名",
        imageLoaderCount: "数量",
    },
};
